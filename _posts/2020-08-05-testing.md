...
It is very convenient to represent this phenomenon as a matrix operation. If you have a vector of inputs $x=\left[\begin{array}{ccc}1 & 2 & 1 \end{array}\right]$ and a vector of weights $w=\left[\begin{array}{ccc}1 & 0 & -1\end{array}\right]$, then the operation above can be conveniently represented as:
